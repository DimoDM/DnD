//#include"../Item.h"
//
//inline const char* Item::convertTypeToString(int t) const {
//
//	switch (t) {
...
//}
//
//inline Item::Item(const int i, const String& n, const int t) {
//	id = i;
//	type = t;
//	name = n;
//}
//
//inline const String Item::itemToString() const {
...
//}
//
//inline void Item::save(std::ofstream& stream) {
...
//}
//
//inline void Item::load(std::ifstream& stream) {
//	size_t lenght;
//	char name[100];
